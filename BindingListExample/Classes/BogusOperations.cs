...
using BindingListExample.Extensions;
using BindingListExample.Models;
using Bogus;
using Person = BindingListExample.Models.Person;

namespace BindingListExample.Classes
{
    public class BogusOperations
    {
        /// <summary>
        /// Pre-defined <see cref="BindingListExample.Models.DeviceType"/> list for generating fake data
        /// </summary>
        ...
        /// <summary>
        /// Generate a list of <see cref="Bogus.Person"/> excluding 
        /// </summary>
